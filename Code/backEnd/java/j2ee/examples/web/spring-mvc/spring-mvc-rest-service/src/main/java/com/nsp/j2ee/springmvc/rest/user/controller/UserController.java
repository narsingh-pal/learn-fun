package com.nsp.j2ee.springmvc.rest.user.controller;
...
import com.nsp.j2ee.springmvc.rest.user.application.util.CustomErrorType;
...
public class UserController {
	...
	@Autowired
	JacksonConverterServiceImpl jacksonConverter;
	
	@RequestMapping("/")
	public String sayHello() {
		return "Hello Spring mvc rest is working hurray!!";
	}
    ...
    public ResponseEntity<?> listUsers() {
        ...
        //String s = jacksonConverter.serialize(users);
