...
import com.nsp.j2ee.liferay.leave.model.LeaveModel;
import com.nsp.j2ee.liferay.leave.model.LeaveSoap;
...
/**
 * The base model implementation for the Leave service. Represents a row in the &quot;nsp_Leave&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class LeaveModelImpl extends BaseModelImpl<Leave> implements LeaveModel {
	 ...
	 */
	public static final String TABLE_NAME = "nsp_Leave";
	...
	public static final String TABLE_SQL_CREATE = "create table nsp_Leave (uuid_ VARCHAR(75) null,leaveId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,leaveName VARCHAR(75) null,startDate DATE null,endDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table nsp_Leave";
	public static final String ORDER_BY_JPQL = " ORDER BY leave.createDate ASC";
	public static final String ORDER_BY_SQL = " ORDER BY nsp_Leave.createDate ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.nsp.j2ee.liferay.leave.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.nsp.j2ee.liferay.leave.model.Leave"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.nsp.j2ee.liferay.leave.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.nsp.j2ee.liferay.leave.model.Leave"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.nsp.j2ee.liferay.leave.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.nsp.j2ee.liferay.leave.model.Leave"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.nsp.j2ee.liferay.leave.service.util.ServiceProps.get(
				"lock.expiration.time.com.nsp.j2ee.liferay.leave.model.Leave"));
	...
	public String toXmlString() {
		...
		sb.append("com.nsp.j2ee.liferay.leave.model.Leave");
