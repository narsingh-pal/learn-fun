...
package com.nsp.j2ee.liferay.leave.service.persistence.impl;
...
import com.nsp.j2ee.liferay.leave.model.impl.LeaveImpl;
import com.nsp.j2ee.liferay.leave.model.impl.LeaveModelImpl;
import com.nsp.j2ee.liferay.leave.service.persistence.LeavePersistence;
 ...
 * @see com.nsp.j2ee.liferay.leave.service.persistence.LeaveUtil
 * @generated
 */
@ProviderType
public class LeavePersistenceImpl extends BasePersistenceImpl<Leave>
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((leave.getUuid() == null) ||
							!leave.getUuid().equals(uuid) ||
							(leave.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
							finderArgs, leave);
					}
				}
	...
	protected Leave toUnwrappedModel(Leave leave) {
		...
		leaveImpl.setUuid(leave.getUuid());
